window.LESSON_CONFIG={"storageKey":"bedside-table-weeks9-10-guided-v1","resetLabel":"Weeks 9-10"};
window.MC_QUESTIONS=[
  {
    "question": "What is the best way to begin drawer or shelf construction and hardware?",
    "options": [
  ...
  {
    "question": "Which result best demonstrates that the drawer or shelf fits neatly and operates smoothly?",
    "options": [
  ...
  {
    "question": "Which safety approach is most appropriate while you use pilot holes, clamps and correct tool control when fitting hardware?",
    "options": [
  ...
  },
  {
    ...
    "options": [
      ...
      "component photos, clearance checks and hardware test notes",
...
window.WRITTEN_QUESTIONS=[
  {
    "title": "1. Explain the key decision in Drawer or shelf construction and hardware",
    "prompt": "Explain how you would approach drawer or shelf construction and hardware and why that approach is reliable. Refer to quality, safety and the project brief.",
    "minWords": 15,
    "concepts": [
      {
  ...
  {
    "title": "2. Evaluate evidence for Drawer or shelf construction and hardware",
