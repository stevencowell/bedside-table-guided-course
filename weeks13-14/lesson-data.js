window.LESSON_CONFIG={"storageKey":"bedside-table-weeks13-14-guided-v1","resetLabel":"Weeks 13-14"};
window.MC_QUESTIONS=[
  {
    "question": "What is the best way to begin surface preparation and defect repair?",
    "options": [
  ...
  {
    "question": "Which result best demonstrates that surfaces are even, smooth and free of glue, scratches and obvious defects?",
    "options": [
  ...
  {
    "question": "Which safety approach is most appropriate while you control dust and wear the required ppe during sanding?",
    "options": [
  ...
  },
  {
    ...
    "options": [
      ...
      "before-and-after surface photos and a sanding record",
...
window.WRITTEN_QUESTIONS=[
  {
    "title": "1. Explain the key decision in Surface preparation and defect repair",
    "prompt": "Explain how you would approach surface preparation and defect repair and why that approach is reliable. Refer to quality, safety and the project brief.",
    "minWords": 15,
    "concepts": [
      {
  ...
  {
    "title": "2. Evaluate evidence for Surface preparation and defect repair",
