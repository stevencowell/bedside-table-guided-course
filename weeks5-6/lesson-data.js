window.LESSON_CONFIG={"storageKey":"bedside-table-weeks5-6-guided-v1","resetLabel":"Weeks 5-6"};
window.MC_QUESTIONS=[
  {
    "question": "What is the best way to begin legs, rails and mortise-and-tenon joinery?",
    "options": [
  ...
  {
    "question": "Which result best demonstrates that joint shoulders are clean, square and fitted without gaps?",
    "options": [
  ...
  {
    "question": "Which safety approach is most appropriate while you use machine guards, clamps and the correct sop for each cut?",
    "options": [
  ...
  },
  {
    ...
    "options": [
      ...
      "marked parts, joint test pieces and dry-fit photos",
...
window.WRITTEN_QUESTIONS=[
  {
    "title": "1. Explain the key decision in Legs, rails and mortise-and-tenon joinery",
    "prompt": "Explain how you would approach legs, rails and mortise-and-tenon joinery and why that approach is reliable. Refer to quality, safety and the project brief.",
    "minWords": 15,
    "concepts": [
      {
  ...
  {
    "title": "2. Evaluate evidence for Legs, rails and mortise-and-tenon joinery",
