window.LESSON_CONFIG={"storageKey":"bedside-table-weeks17-18-guided-v1","resetLabel":"Weeks 17-18"};
window.MC_QUESTIONS=[
  {
    "question": "What is the best way to begin quality checks, evidence and evaluation?",
    "options": [
  ...
  {
    "question": "Which result best demonstrates that the evaluation is supported by clear, relevant evidence?",
    "options": [
  ...
  {
    "question": "Which safety approach is most appropriate while you maintain a tidy, safe workspace while photographing and checking the project?",
    "options": [
  ...
  },
  {
    ...
    "options": [
      ...
      "quality-check table, annotated photos and evaluation notes",
...
window.WRITTEN_QUESTIONS=[
  {
    "title": "1. Explain the key decision in Quality checks, evidence and evaluation",
    "prompt": "Explain how you would approach quality checks, evidence and evaluation and why that approach is reliable. Refer to quality, safety and the project brief.",
    "minWords": 15,
    "concepts": [
      {
  ...
  {
    "title": "2. Evaluate evidence for Quality checks, evidence and evaluation",
