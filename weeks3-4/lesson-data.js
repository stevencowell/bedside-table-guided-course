window.LESSON_CONFIG={"storageKey":"bedside-table-weeks3-4-guided-v1","resetLabel":"Weeks 3-4"};
window.MC_QUESTIONS=[
  {
    "question": "What is the best way to begin working drawings, cutting lists and timber preparation?",
    "options": [
  ...
  {
    "question": "Which result best demonstrates that components are prepared to the correct size from consistent datums?",
    "options": [
  ...
  {
    "question": "Which safety approach is most appropriate while you secure timber and follow machine sops during preparation?",
    "options": [
  ...
  },
  {
    ...
    "options": [
      ...
      "annotated drawing, cutting list and datum-marked stock",
...
window.WRITTEN_QUESTIONS=[
  {
    "title": "1. Explain the key decision in Working drawings, cutting lists and timber preparation",
    "prompt": "Explain how you would approach working drawings, cutting lists and timber preparation and why that approach is reliable. Refer to quality, safety and the project brief.",
    "minWords": 15,
    "concepts": [
      {
  ...
  {
    "title": "2. Evaluate evidence for Working drawings, cutting lists and timber preparation",
