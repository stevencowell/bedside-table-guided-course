window.LESSON_CONFIG={"storageKey":"bedside-table-weeks15-16-guided-v1","resetLabel":"Weeks 15-16"};
window.MC_QUESTIONS=[
  {
    "question": "What is the best way to begin finishing, chemical safety and sustainability?",
    "options": [
  ...
  {
    "question": "Which result best demonstrates that the finish is even, fully cured and appropriate for the table's use?",
    "options": [
  ...
  {
    "question": "Which safety approach is most appropriate while you read the sds and follow ventilation, ppe and rag-disposal rules?",
    "options": [
  ...
  },
  {
    ...
    "options": [
      ...
      "finish test, SDS notes and completed coat record",
...
window.WRITTEN_QUESTIONS=[
  {
    "title": "1. Explain the key decision in Finishing, chemical safety and sustainability",
    "prompt": "Explain how you would approach finishing, chemical safety and sustainability and why that approach is reliable. Refer to quality, safety and the project brief.",
    "minWords": 15,
    "concepts": [
      {
  ...
  {
    "title": "2. Evaluate evidence for Finishing, chemical safety and sustainability",
