window.LESSON_CONFIG={"storageKey":"bedside-table-weeks1-2-guided-v1","resetLabel":"Weeks 1-2"};
window.MC_QUESTIONS=[
  {
    "question": "What is the best way to begin brief, safety and design planning?",
    "options": [
  ...
  {
    "question": "Which result best demonstrates that the table meets the brief for storage, stability and proportion?",
    "options": [
  ...
  {
    "question": "Which safety approach is most appropriate while you identify hazards and apply the relevant sop before using tools?",
    "options": [
  ...
  },
  {
    ...
    "options": [
      ...
      "brief notes, concept sketches and a risk-control check",
...
window.WRITTEN_QUESTIONS=[
  {
    "title": "1. Explain the key decision in Brief, safety and design planning",
    "prompt": "Explain how you would approach brief, safety and design planning and why that approach is reliable. Refer to quality, safety and the project brief.",
    "minWords": 15,
    "concepts": [
      {
  ...
  {
    "title": "2. Evaluate evidence for Brief, safety and design planning",
