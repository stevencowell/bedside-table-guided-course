(function () {
  ...
  nav.setAttribute("aria-label", "Bedside Table course navigation");
  ...
  brand.innerHTML = '<span class="course-family-nav__mark" aria-hidden="true">BT</span><span>Bedside Table</span>';
